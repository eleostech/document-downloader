...
api key and enviroment url variables set in configurations.json  
Parameters listed here can be found at the top of **doc-downloader.ps1**  
    ...
    **$API_KEY** should be set to the API key you are given to access the Eleos API. Set in configurations.json
    **BASE_URL** should be set to the enviroment of the api you want to access. Set in configurations.json
    **DATED_FOLDERS:** If set to $true, documents will be separated into folders based on date. If set to $false, they will put into one folder.  
