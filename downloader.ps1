...
$Header = @{
    'Authorization' = 'key=Eepv+BdqqMjFKIY7CUsL93dp4ILhhyrurjiQLuysjfu6D2PhhA=='
    }
    $Header.Values
$testURI = 'https://squid-fortress-staging.eleostech.com/api/v1/documents/queued/next'
$Header.GetType();
$Header.ToString()
#$var = Invoke-RestMethod -Method GET -URI 'https://squid-fortress-staging.eleostech.com/api/v1/documents/queued/next' -Headers $Header
$var = Invoke-WebRequest -URI $testURI 
$var = Invoke-WebRequest 'https://squid-fortress-staging.eleostech.com/api/v1/documents/queued/next'  -Headers $Header.ToString() -Method GET
